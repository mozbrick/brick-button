...
window.addEventListener('WebComponentsReady', function() {
  ...
  document.head.innerHTML += '<link rel="import" id="el" href="/base/src/brick-button.html">';

  document.querySelector('#el').addEventListener('load', function() {

    // Create the custom element.
    var customElement = document.createElement('brick-button');
...
describe("the brick-button", function(){

  it("should be attached to the DOM", function(){
    expect(document.querySelector("brick-button")).not.to.be.null;
  });
